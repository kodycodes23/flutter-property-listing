...
const String TRANS_PATH = "assets/translations";

class ImageAssets {
  static const String ansvel2 = "$IMAGE_PATH/ansvellogowhite.png";
  static const String ansvel = "$IMAGE_PATH/ansvellogo.png";
...
class TranslationAssets {
  static const String english = "$TRANS_PATH/en-US.json";
  static const String arabic = "$TRANS_PATH/ar-SA.json";
}
